...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        self.model.load_state_dict(load_state_dict_checkpoint(best_model_path, map_location=self.device))
    ...
    def bootstraptest(self, setting, model_dir= None  ):
        ...
        # loaded_state_dict = load_state_dict_checkpoint(model_dir, map_location=self.device)
        
        if model_dir is not None : 
            self.model.load_state_dict(load_state_dict_checkpoint(model_dir, map_location=self.device), strict=False)
        else:
